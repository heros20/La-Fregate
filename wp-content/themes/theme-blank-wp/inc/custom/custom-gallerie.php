...
function wpdocs_codex_gallerie_init() {
    $labels = array(
        'name'                  => _x( 'gallerie', 'Post type general name', 'blank_1' ),
        'singular_name'         => _x( 'gallerie', 'Post type singular name', 'blank_1' ),
        'menu_name'             => _x( 'gallerie', 'Admin Menu text', 'blank_1' ),
        'name_admin_bar'        => _x( 'gallerie', 'Add New on Toolbar', 'blank_1' ),
